...
Ponto de entrada F200TIT do CNAB a receber, será executado após o sistema ler a linha de detalhe e gravar todos os dados.
...
User Function F200TIT()
	...
	If _cRapelBx == "S"			// Executa somente se no cadastro do cliente o campo A1_RAPELBX estiver com Sim
		If cEmpAnt == "01"		// Executa somente para a empresa 01
			If AllTrim(FunName()) == "FINA200" .Or. (AllTrim(FunName()) == "FINA740" .And. aRotina[3][2] == "fA200Gera")
