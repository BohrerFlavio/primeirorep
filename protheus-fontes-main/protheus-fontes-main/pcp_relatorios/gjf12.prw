...
±±ºPrograma  ³GJF12   º Autor ³ Giuliano Forgiarini  º Data ³  07/10/09   º±±
...
User Function GJF12()
	alert('Este relatorio deverá ser ajustado pelo DTI. Procure o setor...')
return                                                                     
/*
...
Local Cabec1         := "Hora    Seq.   Peça  Class. Peso   Prod.    NºAbt                      |Hora    Seq.    Peça  Class. Peso    Prod.     NºAbt"
Local Cabec2         := " "
...
Private limite      := 132
Private tamanho     := "M"
Private nomeprog    := "GJF12" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo       := 18
...
Private CONTFL     := 01
Private m_pag      := 01
Private wnrel      := "GJF12" // Coloque aqui o nome do arquivo usado para impressao em disco    
...
if mv_par07 = 1
cQuery += " AND ZN_COD = '000030' "  
elseif mv_par07 = 2
cQuery += " AND ZN_COD = '000031' "  
endif
...
*/  	       
// Coluna comentada por aumento de dados no relatorio
/*
_lCol := 2
elseif _lCol = 2
@nlin,43 psay '|'
...
elseif TMP->COD = '000030'
if TMP->TPTRASE = 'L'  
@nlin,59 psay 'T.Largo'
else  
@nlin,59 psay 'T.Estr.'
endif
endif

@nlin,67 psay TMP->CLASSIF
@nlin,71 psay transform(TMP->PESO,'@E 99.99')
@nlin,77 psay _cProc
*/
/*      
_lCol := 2
