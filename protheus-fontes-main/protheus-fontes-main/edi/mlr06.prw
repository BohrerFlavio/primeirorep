...
±±ºPrograma  ³MLR06    ºAutor  ³Mauricio Lopes Roehrsº Data ³  11/12/12   º±±
...
Static Function ProcCont()
	...
	_Cli     := '011534'
	_Lj      := '27'   //Alteração solcitada pela Gabriela / Rodrigo  04/10/2018
	...
	for i := 1 to len(aItens)
		...
		//    alert(_prodCli + '  - ' +  str(len(_prodCli))) 
