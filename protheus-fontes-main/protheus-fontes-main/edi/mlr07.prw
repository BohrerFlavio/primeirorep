...
±±ºPrograma  ³MLR07  ºAutor  ³Mauricio Lopes Roehrs  º Data ³  12/12/12   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Geracao de Arquivos EDI NF - Grupo Pão de Açucar           º±±
±±º          ³                                                            º±±
...
Static Function GeraTMP()
	...
	_cQueryI += " F2_CLIENTE = '011534' and "
	_cQueryI += "F2_LOJA IN('01','06','26','27') and " // Alteração solicitada pela Gabriela e Rodrigo 04/10/2018
...
User Function MLR07Pr()
	...
	while TMP->(!eof())
		...
		u_MLR07GE(TMP->DOC,TMP->SERIE,TMP->CLIENTE,TMP->LOJA) 
...
//outros fontes
User Function MLR07GE(_Doc,_Serie,_Cliente,_Loja)    
...
Static Function SFSeleNF(_Doc,_Serie,_Cliente,_Loja)		
	...
	_cQuery += "D2_CLIENTE = '011534' and D2_LOJA IN('01','06','26','27') and " // Alteração solicitada pela Gabriela / Rodrigo 04/10/2018
