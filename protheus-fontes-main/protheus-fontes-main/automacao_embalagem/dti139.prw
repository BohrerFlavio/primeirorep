...
User function DTI131e()
	...
	*/
	...
	_oGet1   := TGet():New(45,30, {|u| If(PCount() > 0, cPreE:= u, cPreE)}, oDlg,, 009, "@!",{||ETQRX()}, 0,,, .F.,, .T.,, .F.,, .F., .F.,, .F., .F.,, cPreE,,,,.t.,)
