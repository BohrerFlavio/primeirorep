...
User Function rh_pdd()        // incluido pelo assistente de conversao do AP5 IDE em 23/08/00
...
Static Function RptDetail()
	...
	Do While !Eof() .and. xFilial() == SRA->RA_FILIAL .And. SRA->RA_MAT <= mv_par02
		...
		li := li + 2 
		@ li, 020 PSAY "      PAGAMENTO DO AVISO PREVIO"
		li := li + 4
		...
		li := li + 3
		@ li, 004 PSAY "Atraves deste e por motivo de ordem particular, venho apresentar a V.Sas. em"
		li := li + 2 
		@ li, 000 PSAY "carater definitivo e irrevogavel o meu  pedido de demissao  do emprego que ocupo"
		li := li + 2
		@ li, 000 PSAY "nesta Empresa  desde a data de "+str(day(SRA->RA_ADMISSA),2,0)+" de "+mesextenso(month(SRA->RA_ADMISSA))+" de "+str(year(SRA->RA_ADMISSA),4,0)+"." 
		li := li + 3
		@ li, 004 PSAY "Tendo interesse  em retirar-me do servico imediatamente, disponho-me a pagar"
		li := li + 2
		@ li, 000 PSAY "o Aviso  Previo de  30 dias de acordo com a lei em vigor."
		li := li + 3
