...
User Function rh_sus()        // incluido pelo assistente de conversao do AP5 IDE em 24/05/01

	//* Programa..: rh_SUS.PRX
	//* Autor.....: Fernando Possoli 
	//* Data......: 23/08/2000
	//* Nota......: Emissao Relatorio Suspensao Disciplinar
	...
	cDesc2  :="de Suspensao Disciplinar."
	cDesc3  :=""
	tamanho :="P"
...
Static Function RptDetail()
	...
	Do While !Eof() .and. xFilial() == SRA->RA_FILIAL .And. SRA->RA_MAT <= mv_par02
		...
		Endif
		li := li + 10
		@ li, 030 PSAY "SUSPENSAO DISCIPLINAR"                             
		li := li + 6
		...
		li := li + 4
		@ li, 000 PSAY "Servimo-nos da presente para aplicar-lhe pena de suspensao disciplinar"           
		li := li + 1
		@ li, 000 PSAY "por ______ (  ) dias, a partir desta data , em razao da irregularidade"
		li := li + 1
		@ li, 000 PSAY "abaixo discriminada:"                                                      
		li := li + 3
		@ li, 000 PSAY "Esclarecemos que irregularidades rejeitadas  autorizam  a  rescisao de"    
		li := li + 1
		@ li, 000 PSAY "contrato de trabalho por justa causa, com base no artigo 482 da CLT."          
		li := li + 3
		@ li, 000 PSAY "Esperamos pois que a partir do seu retorno ao trabalho em ___/___/__"          
		li := li + 1
		@ li, 000 PSAY "V.Sa., procure evitar procedimentos analagos para que nao tenhamos no"
		li := li + 1
		@ li, 000 PSAY "futuro, de tomar as energicas medidas que nos sao facultadas por lei."         
		li := li + 3
		@ li, 000 PSAY "Solicitamos apor o seu ciente na copia desta."                                 
		li := li + 4
		@ li, 000 PSAY "Ciente    ________________________"
		li := li + 1
		@ li, 000 PSAY "Nome        "+SRA->RA_NOME
		li := li + 4
