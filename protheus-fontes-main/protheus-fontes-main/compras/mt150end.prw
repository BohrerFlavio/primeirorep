...
Ponto de Entrada para envio de workflow baseado nas informa็๕es de cota็๕es que estใo sendo geradas pela rotina de atualiza็ใo manual das cota็๕es de compra.
...
@since 		26/03/2019
@param		PARAMIXB[1] - Num้rico - Podendo ser 2-Incluir; 3-alterar; 5-Excluir  
...
// Se for inclusใo de um novo fornecedor
If l150Inclui
	...
	Private _cNumCot := CA150NUM
	Private _cFornece:= CA150FORN
	Private _cLoja   := CA150LOJ

	DbSelectArea("SC8")
	DbSetOrder(1)
	DbSeek(xFilial("SC8") + _cNumCot)
	While !Eof() .And. SC8->C8_FILIAL + SC8->C8_NUM == xFilial("SC8") + _cNumCot
		If SC8->C8_FORNECE == _cFornece .And. SC8->C8_LOJA == _cLoja
...
ฑฑบPrograma  ณ GerEmail บ Autor ณ Evandro Mugnol 	 บ Data ณ 06/03/2019  บฑฑ
...
ฑฑบPrograma  ณ _CancProc บ Autor ณ Evandro Mugnol	 บ Data ณ 06/03/2019  บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ _OkProc  บ Autor ณ Evandro Mugnol 	 บ Data ณ 06/03/2019  บฑฑ
ฑฑฬออออออออออุออออออออออผอออออออฯออออออออออออออออออออผออออออฯอออออออออออออนฑฑ
...
If !Empty(Alltrim(_cEmail))
	...
	Else
		...
		_cTexto += '<p>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;KAENY MIOLA ALBERNAZ Z&Uuml;</strong><br /> &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; Auxiliar de Suprimentos <br /> &nbsp;&nbsp; Frigor&iacute;fico Silva Ind. &amp; Com. Ltda <br /> &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;Fone(55)2103-2525/R 2526 <br /> &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Santa Maria/RS <br /> &nbsp;&nbsp; &nbsp;<a href="mailto:compras4@frigorificosilva.com.br">compras4@frigorificosilva.com.br</a></p>'
		_cTexto += '</body>'
		_cTexto += '</html>'
	Endif*/
	_cTexto += '<p>&nbsp;</p>'
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ _EnvMail บ Autor ณ Evandro Mugnol	 บ Data ณ 06/03/2019  บฑฑ
ฑฑฬออออออออออุออออออออออผอออออออฯออออออออออออออออออออผออออออฯอออออออออออออนฑฑ
...
Static Function _EnvMail(_cMailDest, _cPara, _cAssunto, _cTexto)
	...
	If !_lConectou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel CONECTAR ao servidor de e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _EnvMail no MT150END.")
	EndIf

	// Faz o login no servidor
	_lLogou := mailAuth(_cAccount, _cPassword)
	If !_lLogou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel LOGAR no servidor de e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _EnvMail no MT150END.")
	EndIf
	...
	If !_lEnviou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel ENVIAR o e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _envMail no MT150END.")
	Else
