...
ElseIf AllTrim( RetCodUsr() ) == "000948"	// Se for usuแrio Gilvana Braga
...
If !Empty(Alltrim(_cEmail))
	...
	ElseIf AllTrim( RetCodUsr() ) == "000995"	// Se for usuแrio Renan Santos
		...
		_cTexto += '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RENANA SANTOS<br /> Frigor&iacute;fico Silva Ind. &amp; Com. Ltda.<br /> &nbsp;&nbsp;&nbsp;CNPJ 88.728.027/0001-46<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fone: 55 2103 2517<br /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Fax: 55 2103 2505<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Santa Maria/RS<br /> <a href="mailto:compras2@frigorificosilva.com.br">compras2@frigorificosilva.com.br</a></p>'
		_cTexto += '</body>'
		_cTexto += '</html>'
...
Static Function _EnvMail(_cMailDest, _cPara, _cAssunto, _cTexto)
	...
	If !_lConectou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel CONECTAR ao servidor de e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _EnvMail no MT130WF.")
	EndIf

	// Faz o login no servidor
	_lLogou := mailAuth(_cAccount, _cPassword)
	If !_lLogou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel LOGAR no servidor de e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _EnvMail no MT130WF.")
	EndIf
	...
	If !_lEnviou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel ENVIAR o e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _envMail no MT130WF.")
	Else
