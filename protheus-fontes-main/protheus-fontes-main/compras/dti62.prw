...
ฑฑบPrograma  ณdti62  บAutor  ณ Wellington            บ Data ณ 19/07/2018  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Programa para realizar a limpeza dos flags de contabiliza-บฑฑ
ฑฑบ          ณ cao das notas fiscais de entrada                          บฑฑ
...
User Function dti62()
	...
	DEFINE MSDIALOG oDlg FROM 0,0 TO 300,567 PIXEL TITLE 'Limpeza Flags Contabiliza็ใo (Notas Fiscais de Entrada)'
	...
	IF nOpc == 1
		FOR nX := 1 TO Len(aDados)
			...
			IF aDados[nX , 1] == .T. //para todos os dados do array ele testa se esta marcado o checkbox para deletar do banco
				...
				dbSelectArea("SF1")
				dbSetOrder(1)
				dbSeek(XFilial("SF1")+aDados[nx,3]+aDados[nx,4]+aDados[nx,5]+aDados[nx,6])
...
Static Function _Filtro (aDados,cGetNF, cGetSe, dGetDT, _sFiltro)
	...
	SF1->(_sFiltro := BuildExpr("SF1",oDlg))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณDTI62  บAutor  ณ					     บ Data ณ  08/17/10   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function Nota(aDados, cGetNF, cGetSE, dGetDT, _sFiltro)
	Local lRet:= .T.      
	Local _lContinua	:= .F.
	Local _cFilTel 		:= "F1_FILIAL == '"+xFilial("SF1")+"' "

	IF !empty(cGetNF+cGetSE)
		_cFilTel += " .and. F1_DOC == '"+cGetNF+"' "
		_cFilTel += " .and. F1_SERIE == '"+cGetSE+"' "
		_lContinua	:= .T.
	endif

	IF !empty(dGetDT)
		_cFilTel += " .and. DtoS(F1_EMISSAO) == '"+DtoS(dGetDT)+"' "
		_lContinua	:= .T.
	endif
	...
	IF _lContinua
		...
		aDados:= {}
		Do While !EOF()
			AADD(aDados, {.T., SF1->F1_EMISSAO, SF1->F1_DOC, SF1->F1_SERIE, SF1->F1_FORNECE, SF1->F1_LOJA, SF1->F1_VALBRUT})
			SF1->(dbSkip())
		EndDo
