...
If l151Inclui
	...
	Private _cNumCot := CA151NUM
	Private _cFornece:= CA151FORN
	Private _cLoja   := CA151LOJ
...
ฑฑบPrograma  ณ GerEmail บ Autor ณ Daniel de Souza 	 บ Data ณ 22/07/2019  บฑฑ
...
ฑฑบPrograma  ณ _CancProc บ Autor ณ Daniel de Souza	 บ Data ณ 22/07/2019  บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ _OkProc  บ Autor ณ Daniel de Souza 	 บ Data ณ 22/07/2019  บฑฑ
ฑฑฬออออออออออุออออออออออผอออออออฯออออออออออออออออออออผออออออฯอออออออออออออนฑฑ
...
Static Function _EnvMail(_cMailDest, _cPara, _cAssunto, _cTexto)
	...
	If !_lConectou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel CONECTAR ao servidor de e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _EnvMail no MT151END.")
	EndIf

	// Faz o login no servidor
	_lLogou := mailAuth(_cAccount, _cPassword)
	If !_lLogou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel LOGAR no servidor de e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _EnvMail no MT151END.")
	EndIf
	...
	If !_lEnviou
		MsgAlert("ATENวรO!" + _cNL + "Nใo foi possํvel ENVIAR o e-mail." + _cNL + "Por favor avise o TI." + _cNL + "Rotina _envMail no MT151END.")
	Else
