...
±±ºDesc.     Relatório de Controle de estoque de MP da Embalagem          º±±
±±º          ³ para indústria de porcionados   		                      º±±
...
User Function DTI142()
	...
	Private nomeprog     := "DTI142" // Coloque aqui o nome do programa para impressao no cabecalho
	Private nTipo        := 18
	...
	Private wnrel      	 := "DTI142" // Coloque aqui o nome do arquivo usado para impressao em disco
	pergunte(cPerg,.F.)
	...
	While EST1->(!EOF())
		...
		if mv_par08 == 1
			...
			While EST2->(!eof())
				...
				cCarne := fBuscaCPO('ZAS',1,xfilial('ZAS')+ alltrim(EST2->_CONTRO),'ZAS_PERCGX')
