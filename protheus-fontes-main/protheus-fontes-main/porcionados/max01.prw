...
±±³Funcao    ³ MAX01    ³ MAX MULLER          ³ Data ³ 06/11/2015         ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descricao ³ RECEBIMENTO DE MATERIA PRIMA DE TERCEIROS                  ³±±
...
mBrowse(6,1,22,75,"ZAZ", ,,,,2    ,aCores,,,,{|x| AutoRefresh(x)})
...
ACTIVATE MSDIALOG oDlg ON INIT EnchoiceBar(oDlg,{||lOk := u_mlr58TudOk().and.u_mlr58LinOk(n,'A').and.;
