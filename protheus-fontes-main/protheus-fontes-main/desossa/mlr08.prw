...
±±ºPrograma  ³MLR08   º Autor ³ Mauricio Lopes Roehrs º Data ³  17/01/13  º±±
...
User Function MLR08()
	...
	Private _dDTMaior   := date() + 365
	Private _dDTMenor   := date() - 365
...
static Function mlr08etq()
	...
	pos:=42-t
	MSCBSAY(02,pos,alltrim(ZZ7->ZZ7_DESC),"B","0",fonteDesc)
	...
	pos2:=42-t2  
	MSCBSAY(09,pos2,alltrim(_cDesc),"B","0",fontecorte)
	...
	if (_MSIF $ _sif07) .or. (_MSIF $ _sif07_2)
		MSCBSAY(15,5,'MANTER RESFRIADA DE 0 a 7 GRAUS CELSIUS',"B","0",fonteMesTemp)
	elseif _MSIF $ _sif12
	...
	elseif _MSIF $ _sif04
		MSCBSAY(15,5,'MANTER RESFRIADA DE 0 a 4 GRAUS CELSIUS',"B","0",fonteMesTemp)
	endif 
	...
	MSCBSAY(16,52,substr(dtos(_dDtProd),7,2)+'/'+substr(dtos(_dDtProd),5,2)+'/'+substr(dtos(_dDtProd),3,2),"B","0",fonteData)
	MSCBSAY(21,49,dtoc(dtVALID),"B","0",fonteData) 
	MSCBSAY(21,24,_cSexo,"B","0",fonteNomeCorte1)
	MSCBSAY(21,13,alltrim(_cTara)+'g',"B","0",fonteNomeCorte1)
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	...
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	MSCBSAY(24,41,'INFORMACOES  NUTRICIONAIS: ',"B","0",fonteInfNutri1)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                Parte Comestivel                      ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

	MSCBSAY(24,05,ZZ7->ZZ7_PRTCOM + ',' ,"B","0",fonteInfNutri1)
	MSCBSAY(26,54,'(1 bife pequeno); ',"B","0",fonteInfNutri1)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                Valor Energetico                      ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ                  

	MSCBSAY(26,42,'Valor energ.',"B","0",fonteInfNutri2)
	MSCBSAY(26,26,alltrim(ZZ7->ZZ7_CALQTP),"B","0",fonteInfNutri2)     
	MSCBSAY(26,17,'(' + alltrim(ZZ7->ZZ7_CALVD) + 'VD*); ',"B","0",fonteInfNutri2)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                    Carboidratos                      ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

	MSCBSAY(26,05,'Carboidratos',"B","0",fonteInfNutri2)
	MSCBSAY(28,67,alltrim(ZZ7->ZZ7_CARQTP),"B","0",fonteInfNutri2)  
	MSCBSAY(28,58,'(' + alltrim(ZZ7->ZZ7_CARVD) + 'VD*); ',"B","0",fonteInfNutri2)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                       Proteinas                      ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

	MSCBSAY(28,49,'Proteinas',"B","0",fonteInfNutri2)
	MSCBSAY(28,45,alltrim(ZZ7->ZZ7_PROQTP),"B","0",fonteInfNutri2)    
	MSCBSAY(28,35,'(' + alltrim(ZZ7->ZZ7_PROVD) + 'VD*); ',"B","0",fonteInfNutri2)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                   Gorduras Totais                    ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ                                                   

	MSCBSAY(28,20,'Gorduras Totais',"B","0",fonteInfNutri2)
	MSCBSAY(28,16,alltrim(ZZ7->ZZ7_GTQTP),"B","0",fonteInfNutri2) 
	MSCBSAY(28,05,'(' + alltrim(ZZ7->ZZ7_GTVD) + 'VD*); ',"B","0",fonteInfNutri2)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                 Gorduras Saturadas                   ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

	MSCBSAY(30,58,'Gord. Satur.',"B","0",fonteInfNutri2)
	MSCBSAY(30,55,alltrim(ZZ7->ZZ7_GSQTP),"B","0",fonteInfNutri2)
	MSCBSAY(30,45,'(' + alltrim(ZZ7->ZZ7_GSVD) + 'VD*); ',"B","0",fonteInfNutri2)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                  Gordura Trans.                      ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

	MSCBSAY(30,33,'Gord. Trans.',"B","0",fonteInfNutri2)
	MSCBSAY(30,30,alltrim(ZZ7->ZZ7_GTRTP),"B","0",fonteInfNutri2)      
	MSCBSAY(30,26,'(' + alltrim(ZZ7->ZZ7_GTRVD) + '*); ' ,"B","0",fonteInfNutri2)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                     Colesterol                       ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ                                                               

	MSCBSAY(30,16,'Colesterol',"B","0",fonteInfNutri2)
	MSCBSAY(30,10,alltrim(ZZ7->ZZ7_COLQTP),"B","0",fonteInfNutri2)      
	MSCBSAY(30,05,'(' + alltrim(ZZ7->ZZ7_COLVD),"B","0",fonteInfNutri2)
	MSCBSAY(32,64,'VD*); ' ,"B","0",fonteInfNutri2)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                   Fibra Alimentar                    ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

	MSCBSAY(32,53,'Fibra Alim.',"B","0",fonteInfNutri2)
	MSCBSAY(32,50,alltrim(ZZ7->ZZ7_FIAQTP),"B","0",fonteInfNutri2)
	MSCBSAY(32,41,'(' + alltrim(ZZ7->ZZ7_FIAVD) + 'VD*); ',"B","0",fonteInfNutri2)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³                         Sodio                        ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

	MSCBSAY(32,35,'Sodio',"B","0",fonteInfNutri2)
	MSCBSAY(32,29,alltrim(ZZ7->ZZ7_SODQTP),"B","0",fonteInfNutri2)
	MSCBSAY(32,20,'(' + alltrim(ZZ7->ZZ7_SODVD) + 'VD*); ',"B","0",fonteInfNutri2)
	...
	MSCBSAY(32,05,'*% Valores dia',"B","0",fonteInfNutri2)//rios de                                               
	MSCBSAY(34,04,'rios de referencia  com  base em uma  dieta de 2.000 kcal, ou 8400 kj.',"B","0",fonteInfNutri2)
	MSCBSAY(36,05,'Seus valores diarios podem  ser maiores ou menores dependendo de',"B","0",fonteInfNutri2) 
	MSCBSAY(38,05,'suas necessidades energeticas.**VD nao estabelecido. NAO CONTEM',"B","0",fonteInfNutri2)// 
	MSCBSAY(40,05,'GLUTEN. PRODUZIDO E  EMBALADO POR: FRIGORIFICO  SILVA IND. E',"B","0",fonteInfNutri2)// 
	MSCBSAY(42,05,'COM.LTDA / MATADOURO FRIGORIFICO MB3 BR 392, Km 08 - Bairro',"B","0",fonteInfNutri2)// 
	MSCBSAY(44,05,'Passo das Tropas - Santa Maria - RS - CEP: 97070-160 - CNPJ:',"B","0",fonteInfNutri2)// 
	MSCBSAY(46,06,'88.728.027/0001-46 - IE:  1090096949 -  Industria  Brasileira -',"B","0",fonteInfNutri2)// 
	MSCBSAY(48,06,'DISTRIBUIDO POR: Carrefour Com. e Ind. Ltda. Rua George Eastman,',"B","0",fonteInfNutri2)//
	MSCBSAY(50,06,'213 - CEP: 05690-000 - Sao Paulo - SP CNPJ: 45.543.915/0001',"B","0",fonteInfNutri2)// 
	MSCBSAY(52,43,'-81 - IE: 109.851.690.111',"B","0",fonteInfNutri2)//
	...
	if _cDestMerc = "Merc. Externo"
		MSCBSAY(54,05,'Uso autorizado pelo Ministerio da Agricultura/SIF/DIPOA sob Nr.'+ZZ7->ZZ7_MSIF ,"B","0",fonteInfNutri2)
		//	MSCBSAY(01,69,'SOB Nr '+ZZ7->ZZ7_MSIF,"B","0",fonteInscSIF)Uso autorizado pelo Ministerio da Agricultura/SIF/DISPOA sob nr.
	else	
		MSCBSAY(54,08,'Registro no Ministerio da Agricultura/SIF/DIPOA sob Nr.'+ZZ7->ZZ7_MSIF,"B","0",fonteInfNutri2)
