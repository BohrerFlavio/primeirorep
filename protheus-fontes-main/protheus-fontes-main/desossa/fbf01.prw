...
ฑฑบPrograma  ณfbf01   บ Autor ณ Flแvio Bohrer Flores บ Data ณ  25/03/08   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Impressao de etiqueta interna (Novilho, Angus e Hereford)  บฑฑ
ฑฑบ          ณ OBS - Utiliza-se este modelo por causa do Peso             บฑฑ
ฑฑบ          ณ (unidade de medida)                                        บฑฑ
...
static Function fbf01etq()
	...
	//bloco antigo que estava funcionando at้ o dia 13/09/17
	/*if  alltrim(_cEst) == 'PEX01' .or. alltrim(_cEst) == 'PORC02' .or. alltrim(_cEst) == 'PORC01'	      

	_cIp := alltrim(fBuscaCpo('ZAM',1,xFilial('ZAM')+'IPAL1','ZAM_IP'))	
	MSCBPRINTER('S600','IP',,,,,_cIp) //Impressใo por IP     			

	// Inclusใo para o Porcionados produzir etiquetas internas na PAC02 a pedido de Lucin้ia dia 02/06/2017
	elseif  alltrim(_cEst) == 'PCA02'  .or. alltrim(_cEst) == 'PROTHEUS'	
	_cIp := alltrim(fBuscaCpo('ZAM',1,xFilial('ZAM')+'PCA02','ZAM_IP'))	
	MSCBPRINTER('S600','IP',,,,,_cIp) //Impressใo por IP    		
	Else
	MSCBPRINTER('S600','LPT1')
	endif*/
...
Static Function GeraCabecalho()
	...
	*/
	//MSCBSAY(21,13,alltrim(valor4)+'g',"B","0",fonteNomeCorte1)//tara
	MSCBSAY(21,03,str(valor4 * 1000)+' g',"B","0",fonteNomeCorte1)//tara
