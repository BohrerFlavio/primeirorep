...
User Function ML_CHK1()

	/*/
	ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
	±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
	±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
	±±³Programa  ³ ML_CHK1  ³ Autor ³ Evandro Mugnol        ³ Data ³ 13.12.04 ³±±
	...
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	cString  := "SE1"
	titulo   := "Titulos X Movto Bancario" 
	cDesc1   := "Este programa tem como objetivo imprimir relatorio "
	cDesc2   := "dos titulos X movimentacoes bancarias"
	cDesc3   := ""
	tamanho  := "P"
	limite   := 80
...
Static Function RptDetail()
	...
	Do While !Eof()
		...
		_cTipo    := SE1->E1_TIPO
		_cCliSe1  := SE1->E1_CLIENTE
		_cLojSe1  := SE1->E1_LOJA
		_dEmissao := SE1->E1_EMISSAO
		_nSaldo   := SE1->E1_SALDO

		DbSelectArea("SE5")
		DbSetOrder(7)
		DbSeek(xFilial("SE5")+_cPrefixo+_cNum+_cParcela+_cTipo+_cCliSe1+_cLojSe1)
		If Found()
			_cOcorr := "TITULO C/ SALDO ESTA NO MOVTO BANCARIO"
			_cFlag  := 1
		Else
			_cOcorr := "TITULO OK"
			_cFlag  := 0
