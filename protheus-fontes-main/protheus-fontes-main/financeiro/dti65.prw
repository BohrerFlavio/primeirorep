...
ฑฑบPrograma  ณdti65  บAutor  ณ Wellington            บ Data ณ 19/07/2018  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Programa para realizar a limpeza dos flags de contabiliza-บฑฑ
ฑฑบ          ณ cao dos titulos a pagar		                              บฑฑ
...
User Function dti65()
	...
	DEFINE MSDIALOG oDlg FROM 0,0 TO 300,567 PIXEL TITLE 'Limpeza Flags Contabiliza็ใo (Tํtulos a Pagar)'
	...
	oBrw:= TCBrowse():New(20, 01, 285, 115, , {'', 'Dt Emissใo', 'Tํtulo', 'Prefixo', 'Fornecedor', 'Loja', 'Valor'}, {10, 30, 25, 20, 20, 15, 20}, oDlg,,,,,{||},,,,,,,.F.,,.T.,,.F.,,,)
	...
	IF nOpc == 1
		FOR nX := 1 TO Len(aDados)
			...
			IF aDados[nX , 1] == .T. //para todos os dados do array ele testa se esta marcado o checkbox para deletar do banco
				...
				dbSelectArea("SE2")
				dbSetOrder(18)
				dbSeek(XFilial("SE2")+aDados[nx,3]+aDados[nx,4]+aDados[nx,5]+aDados[nx,6])
...
Static Function _Filtro (aDados,cGetNF, cGetSe, dGetDT, _sFiltro)
	...
	SE2->(_sFiltro := BuildExpr("SE2",oDlg))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณdti65  บAutor  ณ					     บ Data ณ  08/17/10   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function Nota(aDados, cGetNF, cGetSE, dGetDT, _sFiltro)
	Local lRet:= .T.      
	Local _lContinua	:= .F.
	Local _cFilTel 		:= "E2_FILIAL == '"+xFilial("SE2")+"' "

	IF !empty(cGetNF+cGetSE)
		_cFilTel += " .and. E2_NUM == '"+cGetNF+"' "
		_cFilTel += " .and. E2_PREFIXO == '"+cGetSE+"' "
		_lContinua	:= .T.
	endif

	IF !empty(dGetDT)
		_cFilTel += " .and. DtoS(E2_EMISSAO) == '"+DtoS(dGetDT)+"' "
		_lContinua	:= .T.
	endif
	...
	IF _lContinua
		...
		aDados:= {}
		Do While !EOF()
			AADD(aDados, {.T., SE2->E2_EMISSAO, SE2->E2_NUM, SE2->E2_PREFIXO, SE2->E2_FORNECE, SE2->E2_LOJA, SE2->E2_VALOR})
			SE2->(dbSkip())
		EndDo
