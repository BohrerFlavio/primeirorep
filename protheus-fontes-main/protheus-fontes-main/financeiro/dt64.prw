...
ฑฑบPrograma  ณdti64  บAutor  ณ Wellington            บ Data ณ 19/07/2018  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Programa para realizar a limpeza dos flags de contabiliza-บฑฑ
ฑฑบ          ณ cao dos titulos a receber	                              บฑฑ
...
User Function dti64()
	...
	Local dGetDT:= CtoD("")
	Local nX := 0
	Local cNotaFis := "Nบ Tํtulo:"
	Local cSerie   := "Prefixo:"
	...
	DEFINE MSDIALOG oDlg FROM 0,0 TO 300,567 PIXEL TITLE 'Limpeza Flags Contabiliza็ใo (Tํtulos a Receber)'
	...
	oBrw:= TCBrowse():New(20, 01, 285, 115, , {'', 'Dt Emissใo', 'Tํtulo', 'Prefixo', 'Cliente', 'Loja', 'Valor'}, {10, 30, 25, 20, 20, 15, 20}, oDlg,,,,,{||},,,,,,,.F.,,.T.,,.F.,,,)
	...
	IF nOpc == 1
		FOR nX := 1 TO Len(aDados)
			...
			IF aDados[nX , 1] == .T. //para todos os dados do array ele testa se esta marcado o checkbox para deletar do banco
				...
				dbSelectArea("SE1")
				dbSetOrder(29)
				dbSeek(XFilial("SE1")+aDados[nx,3]+aDados[nx,4]+aDados[nx,5]+aDados[nx,6])
...
Static Function _Filtro (aDados,cGetNF, cGetSe, dGetDT, _sFiltro)
	...
	SE1->(_sFiltro := BuildExpr("SE1",oDlg))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณdti64  บAutor  ณ					     บ Data ณ  08/17/10   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function Nota(aDados, cGetNF, cGetSE, dGetDT, _sFiltro)
	Local lRet:= .T.      
	Local _lContinua	:= .F.
	Local _cFilTel 		:= "E1_FILIAL == '"+xFilial("SE1")+"' "

	IF !empty(cGetNF+cGetSE)
		_cFilTel += " .and. E1_NUM == '"+cGetNF+"' "
		_cFilTel += " .and. E1_PREFIXO == '"+cGetSE+"' "
		_lContinua	:= .T.
	endif

	IF !empty(dGetDT)
		_cFilTel += " .and. DtoS(E1_EMISSAO) == '"+DtoS(dGetDT)+"' "
		_lContinua	:= .T.
	endif
	...
	IF _lContinua
		...
		aDados:= {}
		Do While !EOF()
			AADD(aDados, {.T., SE1->E1_EMISSAO, SE1->E1_NUM, SE1->E1_PREFIXO, SE1->E1_CLIENTE, SE1->E1_LOJA, SE1->E1_VALOR})
			SE1->(dbSkip())
		EndDo
