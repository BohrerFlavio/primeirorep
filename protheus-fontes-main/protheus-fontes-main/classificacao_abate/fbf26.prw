...
±±ºPrograma  ³FBF26   º Autor ³ Flavio º Data ³  30/11/10					  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Destino das Carcaças    											  º±±
±±º          ³                                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºUso       ³ Acompanhamento trabalho Certificadores ANGUS               º±±
...
User Function FBF26()
	...
	Local cPict          := ""
	Local titulo         := "DESTINO DE QUARTOS - ANGUS"
	Local nLin           := 80
	...
	Private limite       := 132
	Private tamanho      := "M"
	Private nomeprog     := "FBF26" // Coloque aqui o nome do programa para impressao no cabecalho
	Private nTipo        := 18
	...
	Private CONTFL      := 01
	Private m_pag       := 01
	Private wnrel       := "FBF26" // Coloque aqui o nome do arquivo usado para impressao em disco    
